...
@section('title', 'Реєстрація - УкрАніме')
      ...
      <div class="bg-slate-900/50 backdrop-blur-sm rounded-2xl border border-slate-800 p-8">
        ...
        <div class="space-y-3 mb-6">
          <button class="w-full flex items-center justify-center gap-3 py-3 px-4 bg-slate-800 hover:bg-slate-700 border border-slate-700 rounded-xl transition-colors">
            ...
            <span class="text-gray-300 font-medium">Зареєструватися з Google</span>
          </button>
          <button class="w-full flex items-center justify-center gap-3 py-3 px-4 bg-slate-800 hover:bg-slate-700 border border-slate-700 rounded-xl transition-colors">
            ...
            <span class="text-gray-300 font-medium">Зареєструватися з GitHub</span>
          </button>
        </div>
        ...
        <form class="space-y-5">
          ...
          <div>
            ...
            <div class="mt-2">
              <div class="flex gap-1 mb-1">
                <div class="h-1 flex-1 rounded-full bg-cyan-500"></div>
                <div class="h-1 flex-1 rounded-full bg-cyan-500"></div>
                <div class="h-1 flex-1 rounded-full bg-slate-700"></div>
                <div class="h-1 flex-1 rounded-full bg-slate-700"></div>
              </div>
              <p class="text-xs text-gray-500">Середня надійність</p>
            </div>
          </div>
          <div>
          ...
          <div class="space-y-3">
            <label class="flex items-start gap-3 cursor-pointer">
              <input type="checkbox" class="w-4 h-4 mt-0.5 rounded border-slate-600 bg-slate-800 text-cyan-500 focus:ring-cyan-500 focus:ring-offset-0">
              <span class="text-sm text-gray-400">Я погоджуюсь з <a href="#" class="text-cyan-400 hover:text-cyan-300">Умовами використання</a> та <a href="#" class="text-cyan-400 hover:text-cyan-300">Політикою конфіденційності</a></span>
            </label>
            <label class="flex items-start gap-3 cursor-pointer">
              <input type="checkbox" class="w-4 h-4 mt-0.5 rounded border-slate-600 bg-slate-800 text-cyan-500 focus:ring-cyan-500 focus:ring-offset-0">
        ...
        <p class="text-center text-gray-400 mt-6">
          Вже маєте акаунт? <a href="{{ route('login') }}" class="text-cyan-400 hover:text-cyan-300 font-medium transition-colors">Увійти</a>
        </p>
      </div>
    </div>
@endsection
