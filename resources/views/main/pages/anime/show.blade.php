                        ...
                        <a href="{{ route('anime.show', 'example-slug') }}" class="group">
                            <div class="relative mb-2">
                                ...
                                <div class="absolute bottom-2 right-2 z-10 opacity-0 group-hover:opacity-100 transition-opacity list-menu-container">
                                    <div class="relative">
                                        <button type="button" onclick="toggleListMenu(event, this)"
                                                class="w-7 h-7 bg-slate-900/90 backdrop-blur-sm rounded-lg flex items-center justify-center hover:bg-cyan-500 transition-colors">
                                        ...
                                        <div class="list-dropdown hidden absolute bottom-full right-0 mb-2 w-44 bg-slate-800 border border-slate-700 rounded-xl shadow-2xl overflow-hidden"
                                             onclick="event.stopPropagation()">
                                            <button type="button"
                                                    class="w-full px-4 py-2.5 text-left text-sm text-gray-300 hover:bg-slate-700 hover:text-cyan-400 transition-colors flex items-center gap-3">
                                                <span class="text-cyan-400">▶</span> Дивлюсь
                                            </button>
                                            <button type="button"
                                                    class="w-full px-4 py-2.5 text-left text-sm text-gray-300 hover:bg-slate-700 hover:text-cyan-400 transition-colors flex items-center gap-3">
                                                <span class="text-amber-400">📋</span> Заплановано
                                            </button>
                                            <button type="button"
                                                    class="w-full px-4 py-2.5 text-left text-sm text-gray-300 hover:bg-slate-700 hover:text-cyan-400 transition-colors flex items-center gap-3">
                                                <span class="text-green-400">✓</span> Переглянуто
                                            </button>
                                            <button type="button"
                                                    class="w-full px-4 py-2.5 text-left text-sm text-gray-300 hover:bg-slate-700 hover:text-cyan-400 transition-colors flex items-center gap-3">
                                                <span class="text-red-400">✗</span> Кинув
                                            </button>
                                            <div class="border-t border-slate-700"></div>
                                            <button type="button"
                                                    class="w-full px-4 py-2.5 text-left text-sm text-gray-300 hover:bg-slate-700 hover:text-red-400 transition-colors flex items-center gap-3">
                                                <span class="text-red-400">♥</span> Улюблене
                                            </button>
                                        </div>
                                    </div>
                                </div>
